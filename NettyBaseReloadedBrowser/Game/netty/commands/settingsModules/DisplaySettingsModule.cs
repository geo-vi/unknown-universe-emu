namespace NettyBaseReloadedBrowser.Game.netty.commands.settingsModules
{
	class DisplaySettingsModule : IServerCommand
	{
		public static int ID = 31318;
	    ...
	    public override void write()
	    {
            ...
            writeBoolean(varC4s);
            writeBoolean(var23m);
            writeBoolean(displayNotifications);
            writeBoolean(showNotOwnedItems);
            writeInt(varE4V << 3 | varE4V >> 29);
            writeBoolean(varN2e);
            writeBoolean(vardu);
            writeInt(displaySetting3DsizeTextures >> 3 | displaySetting3DsizeTextures << 29);
            writeInt(displaySetting3DqualityAntialias << 1 | displaySetting3DqualityAntialias >> 31);
            writeBoolean(vard2k);
            writeInt(displaySetting3DtextureFiltering << 10 | displaySetting3DtextureFiltering >> 22);
            writeBoolean(varGx);
            writeBoolean(varR2C);
            writeBoolean(proActionBarKeyboardInputEnabled);
            writeBoolean(proActionBarAutohideEnabled);
            writeInt(varV4A << 7 | varV4A >> 25);
            writeInt(displaySetting3DqualityTextures << 16 | displaySetting3DqualityTextures >> 16);
            writeBoolean(varc4A);
            writeInt(displaySetting3DqualityEffects << 9 | displaySetting3DqualityEffects >> 23);
            writeBoolean(varVO);
            writeBoolean(varD2I);
            writeBoolean(preloadUserShips);
            writeBoolean(varIf);
            writeBoolean(varN17);
            writeInt(displaySetting3DqualityLights << 15 | displaySetting3DqualityLights >> 17);
            writeBoolean(varb1H);
            writeBoolean(displayChat);
            writeBoolean(displayHitpointBubbles);
            writeBoolean(proActionBarEnabled);
            writeBoolean(varA1P);
            writeBoolean(displayResources);
        }
	}
}
