namespace NettyBaseReloadedBrowser.Game.netty.commands
{
    class VisualModifierCommand : IServerCommand
    {
        ...
        public short varcc = 0;

        public VisualModifierCommand(bool activated, short varcc, string varl11, int attribute, int varGX, int count)
        {
