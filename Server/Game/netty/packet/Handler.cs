...
namespace Server.Game.netty.packet
{
    class Handler
    {
        ...
        {                
            ...
            else if (parser.CMD_ID == commands.new_client.requests.LoginRequest.ID)
            {
            ...
            else
            {
                ...
                Console.WriteLine("IP : " + client.IpEndPoint + "; Data command ID: " + parser.CMD_ID + ", Data command length: " + parser.Lenght);
            }
        }
    }
}
