...
namespace Server.Game.netty.commands.new_client
{
    class AssetTypeModule
    {
        ...
        public const short TDM = 43;

        public const short HQ = 47;

        public const short HANGAR = 49;

        public const short ORE_TRADE = 51;

        public const short REPAIR_DOCK = 54;

        public const short STATION_TURRET_SMALL = 56;

        public const short STATION_TURRET_LARGE = 58;
